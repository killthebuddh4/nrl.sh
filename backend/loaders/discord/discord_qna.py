...
async def main(query, channel_ids_raw):
    ...
    documents = await reader.load_data(channel_ids=[970784992269594705])
...
def discord(query, channel_ids_raw):
  ...
  DiscordReader = download_loader('DiscordReader')
  print("channel ids: ", channel_ids_raw)
...
r = discord(query="what has been said?", channel_ids_raw=[970784992269594705]) #replace with your channel id
print("response: ", r)