...
--
-- Name: openai_usage_logs; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE "public"."openai_usage_logs" OWNER TO "postgres";
...
--
-- Name: query_embeddings; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE "public"."query_embeddings" OWNER TO "postgres";

--
-- Name: question_completion_errors; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE "public"."question_completion_errors" (
    "id" "uuid" NOT NULL,
    "created_at" timestamp with time zone NOT NULL,
    "message" "text" NOT NULL,
    "topic_completion_id" "uuid" NOT NULL
);


ALTER TABLE "public"."question_completion_errors" OWNER TO "postgres";

--
-- Name: question_completions; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE "public"."question_completions" OWNER TO "postgres";

--
-- Name: source_docs; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE "public"."source_docs" (
    "id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "text_from_html" "text" NOT NULL,
    "page_url" "text" NOT NULL,
    "pipeline_id" "uuid" NOT NULL
);


ALTER TABLE "public"."source_docs" OWNER TO "postgres";

--
-- Name: topic_completion_errors; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE "public"."topic_completion_errors" (
    "id" "uuid" NOT NULL,
    "created_at" timestamp with time zone NOT NULL,
    "message" "text" NOT NULL,
...
ALTER TABLE "public"."topic_completion_errors" OWNER TO "postgres";
...
--
-- Name: openai_usage_logs openai_usage_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: query_embeddings query_embeddings_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."query_embeddings"
    ADD CONSTRAINT "query_embeddings_pkey" PRIMARY KEY ("id");


--
-- Name: question_completion_errors question_completion_errors_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."question_completion_errors"
    ADD CONSTRAINT "question_completion_errors_pkey" PRIMARY KEY ("id");


--
-- Name: question_completions question_completions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."question_completions"
    ADD CONSTRAINT "question_completions_pkey" PRIMARY KEY ("id");


--
-- Name: source_docs text_from_html_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."source_docs"
    ADD CONSTRAINT "text_from_html_pkey" PRIMARY KEY ("id");


--
-- Name: topic_completion_errors topic_completion_errors_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."topic_completion_errors"
    ADD CONSTRAINT "topic_completion_errors_pkey" PRIMARY KEY ("id");


--
-- Name: topic_completions topics_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: question_completion_errors question_completion_errors_topic_completion_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."question_completion_errors"
    ADD CONSTRAINT "question_completion_errors_topic_completion_id_fkey" FOREIGN KEY ("topic_completion_id") REFERENCES "public"."topic_completions"("id") ON DELETE CASCADE;


--
-- Name: question_completions question_completions_topic_completion_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."question_completions"
    ADD CONSTRAINT "question_completions_topic_completion_id_fkey" FOREIGN KEY ("topic_completion_id") REFERENCES "public"."topic_completions"("id") ON DELETE CASCADE;


--
-- Name: source_docs source_docs_pipeline_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."source_docs"
    ADD CONSTRAINT "source_docs_pipeline_id_fkey" FOREIGN KEY ("pipeline_id") REFERENCES "public"."pipelines"("id") ON DELETE CASCADE;


--
-- Name: topic_completion_errors topic_completion_errors_source_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."topic_completion_errors"
    ADD CONSTRAINT "topic_completion_errors_source_doc_id_fkey" FOREIGN KEY ("source_doc_id") REFERENCES "public"."source_docs"("id") ON DELETE CASCADE;


--
-- Name: topic_completions topic_completions_source_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."topic_completions"
    ADD CONSTRAINT "topic_completions_source_doc_id_fkey" FOREIGN KEY ("source_doc_id") REFERENCES "public"."source_docs"("id") ON DELETE CASCADE;


--
-- Name: source_docs; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."source_docs" ENABLE ROW LEVEL SECURITY;

--
-- Name: topic_completions; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "openai_usage_logs"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."openai_usage_logs" TO "anon";
GRANT ALL ON TABLE "public"."openai_usage_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."openai_usage_logs" TO "service_role";
...
--
-- Name: TABLE "query_embeddings"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."query_embeddings" TO "anon";
GRANT ALL ON TABLE "public"."query_embeddings" TO "authenticated";
GRANT ALL ON TABLE "public"."query_embeddings" TO "service_role";


--
-- Name: TABLE "question_completion_errors"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."question_completion_errors" TO "anon";
GRANT ALL ON TABLE "public"."question_completion_errors" TO "authenticated";
GRANT ALL ON TABLE "public"."question_completion_errors" TO "service_role";


--
-- Name: TABLE "question_completions"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."question_completions" TO "anon";
GRANT ALL ON TABLE "public"."question_completions" TO "authenticated";
GRANT ALL ON TABLE "public"."question_completions" TO "service_role";


--
-- Name: TABLE "source_docs"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."source_docs" TO "anon";
GRANT ALL ON TABLE "public"."source_docs" TO "authenticated";
GRANT ALL ON TABLE "public"."source_docs" TO "service_role";


--
-- Name: TABLE "topic_completion_errors"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."topic_completion_errors" TO "anon";
GRANT ALL ON TABLE "public"."topic_completion_errors" TO "authenticated";
GRANT ALL ON TABLE "public"."topic_completion_errors" TO "service_role";


--
-- Name: TABLE "topic_completions"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."topic_completions" TO "anon";
GRANT ALL ON TABLE "public"."topic_completions" TO "authenticated";
GRANT ALL ON TABLE "public"."topic_completions" TO "service_role";
